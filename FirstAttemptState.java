 ...
 */
public class FirstAttemptState implements SwirldState {
	/**
	...
	public synchronized FastCopyable copy() {
		FirstAttemptState copy = new FirstAttemptState();
		copy.copyFrom(this);
		return copy;
	}
	...
	public synchronized void copyFrom(SwirldState old) {
		strings = Collections.synchronizedList(
				new ArrayList<String>(((FirstAttemptState) old).strings));
		addressBook = ((FirstAttemptState) old).addressBook.copy();
	}
